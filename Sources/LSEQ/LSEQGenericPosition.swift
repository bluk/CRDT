...
public struct LSEQGenericPosition<Element, P>: LSEQ where P: Position {
    public typealias PositionType = P
    ...
    public func makeDifferenceOperations(from other: LSEQGenericPosition<Element, PositionType>) -> [Operation] {
...
extension LSEQGenericPosition.Operation: Equatable where Element: Equatable {}

extension LSEQGenericPosition.Operation: Codable where Element: Codable, PositionType: Codable {}

extension LSEQGenericPosition.ElementContainer: Codable where Element: Codable, PositionType: Codable {}

extension LSEQGenericPosition.ElementContainer: Equatable where Element: Equatable {}

extension LSEQGenericPosition: Codable where Element: Codable, PositionType: Codable, PositionType.Segment: Codable,
    PositionType.Segment.Identifier: Codable, PositionType.Segment.Source: Codable, PositionType.Clock: Codable {}

extension LSEQGenericPosition: Equatable where Element: Equatable {}
